...
$(function(){
	...
	// 三级菜单
	$(".sub_menu .sub_li_menu a").click(function(){
		var parentli = $(this).parent("li");
		parentli.addClass("cur");
		parentli.siblings().removeClass("cur");
		
		parentli.siblings().children(".sub_ul_menu").slideUp(400);			
		parentli.siblings().find(".arrow_down").css("background-position","0 0");
		
		var sub_ul = parentli.children(".sub_ul_menu");
			
		if(sub_ul.css('display') == 'none'){
			sub_ul.slideDown(400);
			sub_ul.parent().find(".arrow_down").css("background-position","0 -16px");
			
		}else{
			sub_ul.slideUp(400);	
			sub_ul.parent().find(".arrow_down").css("background-position","0 0px");
		}
	})
	
	$(".sub_ul_menu li").click(function(){
		$(this).addClass("cur");
...
$(function(){
	$(".menu_ctl").click(function(){
		if( $(".sider_bar").css("left") == "0px" ){
			$(".sider_bar").css("left","-230px")
			$(".content_main").css("left","0px")
			$(this).find("img").css("margin-top","-0px")
			}
		else{$(".sider_bar").css("left","0px")
			$(".content_main").css("left","230px");
