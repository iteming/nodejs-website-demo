  ...
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
      ...
      , max:            "这个值应小于或等于%s."
      , range:          "这个值应为 %s ~ %s 之间."
      , minlength:      "这个值的长度太短了. 应该大于或等于 %s."
      , maxlength:      "这个值的长度太长了. 应该小于或等于 %s."
      , rangelength:    "这个值的长度是无效的. 应为 %s ~ %s 之间."
      , mincheck:       "您必须至少选择 %s 个选项."
      , maxcheck:       "您必须最多选择 %s 个选项."
      , rangecheck:     "您必须选择 %s ~ %s 个选项."
      , equalto:        "这个值应该是相同的."
    },
      ...
      , type: function ( val, type ) {
        ...
        switch ( type ) {
          ...
          case 'phone':
              ...
              break;
          case 'mobile':
              regExp = /^0{0,1}(13[0-9]|145|147|15[0-3]|15[5-9]|180|18[5-9])[0-9]{8}$/;
              break;
          default:
            return false;
        }
